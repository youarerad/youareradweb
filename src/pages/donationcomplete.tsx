...
export default function Donationcomplete() {
  ...
  if (status === 'success' && data.mode === 'payment') {
    return (
      <div>
        <section className="mt-10">
          ...
          <div className="max-w-2xl p-10 mx-auto mt-10 space-y-10 text-left border-4 rounded-xl">
            <div className="inline-block" id="donation">
              ...
              <div>
                <h4 className="mt-4 text-base font-bold">To: {data?.customer_details?.name} </h4>
                <p className="mt-4">
                  Thank you for making an incredible contribution of{' '}
                  <span className="font-bold">${donationString}</span> to our cause. With your
                  support, Rise Above The Disorder will be able to cover the cost of{' '}
                  <span className="font-bold">{donationImpact} week(s) of therapy sessions! </span>
                </p>
                <p className="mt-4">
  ...
  if (status === 'success' && data.mode === 'subscription') {
    return (
      <div>
        <section className="mt-10">
          <header>
            <h1 className="text-center">
              ...
              <span className="text-transparent bg-gradient-to-r from-secondary-light to-primary-light bg-clip-text sm:block">
                Your membership makes healing possible!{' '}
              </span>
            </h1>
          </header>
          <div className="max-w-2xl p-10 mx-auto mt-10 space-y-10 text-left border-4 rounded-xl">
