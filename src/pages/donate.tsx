      ...
      <section>
        ...
        <Tab.Group vertical>
          <div className="grid grid-cols-1 sm:grid-cols-4 items-center">
            <Tab.List className="grid gap-2 sm:gap-x-0 grid-cols-2 sm:flex sm:flex-col sm:space-y-2 order-2 sm:order-1 mt-10 sm:mt-0">
            ...
            <Tab.Panels className="col-span-3 order-1 sm:order-2">
              <TabPanel>
                <CareGenderChart />
              </TabPanel>
              <TabPanel>
